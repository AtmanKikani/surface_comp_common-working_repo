...
int main(int argc, char** argv) {
    ...
    while (ros::ok()) {
        ...
        // Create a sensor_msgs::CompressedImage message
        // sensor_msgs::CompressedImage compressed_msg;
        // compressed_msg.header.stamp = ros::Time::now();
        // compressed_msg.format = "jpeg";
        // compressed_msg.data = compressed_data;
        sensor_msgs::CompressedImagePtr msg1 = cv_bridge::CvImage(std_msgs::Header(), "jpeg", frame1).toCompressedImageMsg();
        sensor_msgs::CompressedImagePtr msg2 = cv_bridge::CvImage(std_msgs::Header(), "jpeg", frame2).toCompressedImageMsg();
        pub1.publish(msg1);
        pub2.publish(msg2);
    }
    cap1.release();
